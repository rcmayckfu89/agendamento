        ...
        <div className="flex flex-col h-full relative animate-slide-in-up">
            <header className="flex justify-between items-center mb-10">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Medicamentos Controlados</p>
                </div>
                <div className="flex items-center gap-4">
                    <button
                        onClick={handleOpenHistory}
                        className="bg-card text-secondary-foreground font-medium py-2.5 px-5 rounded-lg flex items-center gap-2 hover:bg-secondary transition-colors border border-border shadow-soft"
                    >
            ...
            <div className="mb-6">
                <div className="relative flex-1">
                    ...
                    <input
                        type="text"
                        placeholder="Buscar por paciente, CPF ou registro"
                        value={searchTerm}
